    ...
    >
      <Box className="flex items-start gap-5 w-full">
        ...
        <Box className="flex flex-col gap-2 py-2 w-full bg-200">
          <Box className="w-full flex justify-between border-b-[2px] border-green-color">
            <Text className="text-xl text-main-blue uppercase font-bold font-mono">
              {collectionData.name}
            </Text>
          ...
          <Box className="w-full flex justify-between">
            <Text className="text-text-color font-bold font-mono">Status:</Text>
          ...
          <Box className="w-full flex justify-between">
            ...
            <Countdown
              className="text-text-color font-mono"
          ...
          <Box className="w-full flex justify-between font-mono">
            ...
            <Text className="text-text-color font-mono">
