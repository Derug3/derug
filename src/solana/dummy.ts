  ...
  async (): Promise<IChainCollectionData> => {
    ...
    const [derugData] = PublicKey.findProgramAddressSync(
      [
        derugDataSeed,
        new PublicKey(
          "C8v1JF55UrBDdoAmCYAeaYRuxXKMkkqWGsCJs1suU3WC"
        ).toBuffer(),
      ],
    ...
    return {
      collectionMint: "C8v1JF55UrBDdoAmCYAeaYRuxXKMkkqWGsCJs1suU3WC",
      hasActiveDerugData,
      slug: "boogle_gen",
      totalSupply: 99,
      rugUpdateAuthority: "BNKffxMgGeRzC3mKPxgucDMDiQspQJfHv2owZAo6AdQY",
